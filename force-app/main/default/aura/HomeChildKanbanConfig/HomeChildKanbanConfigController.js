    ...
    objChanged : function(component, event, helper) {
        ...
        action.setCallback(this, function(res){
            ...
            if(state === 'SUCCESS'){
                ...
                //Adicionado [30. 10]
                component.set('v.recordTypes', '');
                component.set('v.recordTypeList', []);
                helper.loadRecordTypes(component, objectName);
                
                var apiFieldName = component.get("v.apiFieldName");
                var apiFieldNameValue = component.get("v.apiFieldNameValue");
                helper.loadApiFieldNameValues(component, objectName, apiFieldName, apiFieldNameValue);

...
({
    handleRecordUpdated : function(component, event, helper){
        ...
        if(!$A.util.isUndefinedOrNull(currentRec)){
            ...
            var objApiFieldName = recFlds.ApiFieldName__c.value;
            var objApiFieldNameValue = recFlds.ApiFieldNameValue__c.value;
            console.log('[KanbanController] apiFieldNameValue 1: ' + objApiFieldNameValue);
            ...
            if(objName && objFields && kanbanPicklistField){
                ...
                action.setParams({
                    ...
                    'apiFieldName': objApiFieldName,
                    'apiFieldNameValue': objApiFieldNameValue
                });
                console.log('[KanbanController] apiFieldNameValue 2: ' + objApiFieldNameValue);
